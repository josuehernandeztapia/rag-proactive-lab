...
def ocr_image_openai(image_url: str, kind: str = "evidencia") -> Optional[dict]:
    ...
    try:
        ...
        if b:
            ...
            try:
                import storage as _st  # type: ignore
                _st.log_event('media_fetch_failed', {'url': image_url, 'media_type': 'image'})
            except Exception:
                pass
    except Exception:
        pass
    ...
    try:
        ...
        # Permitir seleccionar el modelo por variable de entorno
        ...
        try:
            import storage as _st  # type: ignore
            _st.log_event('ocr_error', {'url': image_url, 'reason': 'openai_vision_exception', 'error': str(e)})
        except Exception:
            pass
        return None
